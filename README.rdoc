...
<b>** WARNING **</b>  This Application is for education purposes and is not meant to be used 
	       to illegally download TV Shows or Movies.

== Configuration
	
Below we have a basic Series config file:
